        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
              DevConnect is a modern social platform designed for developers to connect, 
              share their projects, and grow together as a community. Join thousands of 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/feed" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Feed
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/features" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Features
                </Link>
              </li>
              <li>
